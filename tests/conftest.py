...
def _get_api_key():
    ...
    return os.environ.get('PP_API_KEY', 'There is no environment variable set for PP_API_KEY')


@pytest.fixture(scope='session')
def _get_api_secret():
    # Set this variable to run live tests
    return os.environ.get('PP_API_SECRET', 'There is no environment variable set for PP_API_SECRET')
