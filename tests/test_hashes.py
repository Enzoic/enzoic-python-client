...
class TestEnzoic:
    ...
    def test_unsalted_sha_1(self):
        assert (
            ...
            == Hashing.calc_sha1_unsalted_hash("password")
        )

    def test_unsalted_md5(self):
        assert "5f4dcc3b5aa765d61d8327deb882cf99" == Hashing.calc_md5_unsalted_hash(
            "password"
        )

    def test_ipboard_mybb_hash(self):
        assert "96c06579d8dfc66d81f05aab51a9b284" == Hashing.calc_ipboard_mybb_hash(
            "123456", "12345"
        )
    ...
    def test_vbulletin_pre_385_hash(self):
        assert (
            ...
            == Hashing.calc_vbulletin_pre_3_8_5_hash("123456", "123")
        )

    def test_vbulletin_post_385_hash(self):
        assert (
            "77d3b7ed9db7d236b9eac8262d27f6a5"
            == Hashing.calc_vbulletin_post_3_8_5_hash("123456", "123")
        )
    ...
    def test_get_phpbb3_hash(self):
        assert "$H$993WP3hbzy0N22X06wxrCc3800D2p41" == Hashing.calc_phpbb3_hash(
            "123456789", "$H$993WP3hbz"
        )
    ...
    def test_custom_algorithm_2_hash(self):
        assert (
            ...
            == Hashing.calc_custom_algorithm_2_hash("123456", "123")
        )
    ...
    def test_custom_algorithm_3_hash(self):
        assert (
            "abe45d28281cfa2a4201c9b90a143095"
            == Hashing.calc_custom_algorithm_3_hash("test", "123")
        )

    def test_md5crypt_hash(self):
        assert "$1$4d3c09ea$hPwyka2ToWFbLTOq.yFjf." == Hashing.calc_md5crypt_hash(
            "123456", "4d3c09ea"
        )
    ...
    def test_custom_algorithm_4_hash(self):
        assert (
            ...
            == Hashing.calc_custom_algorithm_4_hash(
    ...
    def test_oscommerce_aef_hash(self):
        assert "d2bc2f8d09990ebe87c809684fd78c66" == Hashing.calc_oscommerce_aef_hash(
            "password", "123"
        )
    ...
    def test_get_mysql_post_4_1(self):
        assert (
            ...
            == Hashing.calc_mysql_post_4_1("test")
        )
    ...
    def test_punbb_hash(self):
        assert "0c9a0dc3dd0b067c016209fd46749c281879069e" == Hashing.calc_punbb_hash(
            "password", "123"
        )
    ...
    def test_sha1_salted_hash(self):
        assert (
            ...
            == Hashing.calc_sha1_salted_hash("test", "123")
        )
    ...
    def test_partial_md5_29_hash(self):
        assert "5f4dcc3b5aa765d61d8327deb882c" == Hashing.calc_partial_md5_29_hash(
            "password"
        )
    ...
    def test_ave_datalife_diferior_hash(self):
        assert (
            ...
            == Hashing.calc_ave_datalife_diferior_hash("password")
        )

    def test_django_md5_hash(self):
        assert (
            "md5$c6218$346abd81f2d88b4517446316222f4276"
            == Hashing.calc_django_md5_hash("password", "c6218")
        )
    ...
    def test_pligg_cms_hash(self):
        assert (
            ...
            == Hashing.calc_pligg_cms_hash("password", "123")
        )

    def test_run_cms_smf1_1_hash(self):
        assert (
            "0de084f38ace8e3d82597f55cc6ad5d6001568e6"
            == Hashing.calc_run_cms_smf1_1("password", "123")
        )
    ...
    def test_sha1_dash(self):
        assert "55566a759b86fbbd979b579b232f4dd214d08068" == Hashing.calc_sha1dash_hash(
            "123456", "478c8029d5efddc554bf2fe6bb2219d8c897d4a0"
        )
    ...
    def test_custom_algorithm_9_hash(self):
        assert (
            ...
            == Hashing.calc_custom_algorithm_9_hash(
                "0rangepeel", "6kpcxVSjagLgsNCUCr-D"
            )
        )
...
class TestCalcArgon2:
    ...
    def test_argon2_hash_2(self):
        assert (
            ...
            == Hashing.calc_argon_2_hash(
                "password", "$argon2i$v=19$m=4096,t=2,p=4,l=24$c29tZXNhbHQ"
            )
        )
    ...
    def test_argon2_hash_3(self):
        assert (
            "$argon2d$v=19$m=1024,t=3,p=2$c2FsdHlzYWx0$EklGIPtCSWb3IS+q4IQ7rwrwm2o"
            == Hashing.calc_argon_2_hash(
                "123456", "$argon2d$v=19$m=1024,t=3,p=2,l=20$c2FsdHlzYWx0"
            )
        )
    ...
    def test_argon2_hash_4(self):
        assert (
            ...
            == Hashing.calc_argon_2_hash(
                "password", "$argon2i$v=19$m=1024,t=2,p=2,l=20$c29tZXNhbHQ"
            )
        )
    ...
    def test_argon2_hash_5(self):
        assert (
            ...
            == Hashing.calc_argon_2_hash(
                "password", "$argon2i$v=19$m=4096,t=2,p=4,l=32$c29tZXNhbHQ"
            )
        )
    ...
    def test_argon2_hash_6(self):
        assert (
            "$argon2d$v=19$m=1024,t=3,p=2$c2FsdHlzYWx0$EklGIPtCSWb3IS+q4IQ7rwrwm2o"
            == Hashing.calc_argon_2_hash(
                "123456", "$argon2d$v=19$m=10d4,t=ejw,p=2$c2FsdHlzYWx0"
            )
        )
